...
<base base="<?php echo INCLUDE_PATH_PAINEL; ?>">
    ...
    <header>
        <div class="container">
            ...
            <div class="loggout">
                <a <?php if(@$_GET['url'] == 'chat'){ ?> style="background-color: #60727a;" <?php } ?> href="<?php echo INCLUDE_PATH_PAINEL ?>chat"><i class="far fa-comments"></i><span> Chat Online</span></a>
                <a <?php if(@$_GET['url'] == ''){ ?> style="background-color: #60727a;" <?php } ?> href="<?php echo INCLUDE_PATH_PAINEL ?>"><i class="fas fa-home"></i><span> Página Inicial</span></a>
